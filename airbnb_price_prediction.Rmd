...
# TODO: mention it's a regression problem
...
paste("RMSE final model:", round(MAE, 2), "R^2 final model:", round(Rsq, 2), "RMSE final model:", round(RMSE, 2))
...
pred_obs <- rf_cv_results$pred %>% dplyr::filter(str_sub(Resample, start=7, end=12) == "Rep001")
pred_obs
...
boot_data <- boot(data, bootstap_validation, R=10)
boot_data
